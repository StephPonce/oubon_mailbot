    ...
    def save_products(self, products: List[Dict]):
        ...
        for product in products:
            ...
            """, (
                ...
                product.get('profit_margin') or 0,
                product.get('estimated_profit') or (product.get('price') or 0) - (product.get('cost') or 0),  # Calculate if missing
                product.get('rating') or 4.5,
                product.get('orders') or 1000,
                product.get('velocity_score') or 0,
