          ...
          {step === 1 && (
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <h3 className="font-semibold text-gray-900 text-lg mb-2">Price Test</h3>
              ...
              >
                ...
                <h3 className="font-semibold text-gray-900 text-lg mb-2">Title Test</h3>
                <p className="text-sm text-gray-600">
              ...
              >
                <FileText className="w-10 h-10 text-purple-600 mb-3 group-hover:scale-110 transition-transform" />
                <h3 className="font-semibold text-gray-900 text-lg mb-2">Description Test</h3>
                <p className="text-sm text-gray-600">
              ...
              >
                ...
                <h3 className="font-semibold text-gray-900 text-lg mb-2">Image Test</h3>
                <p className="text-sm text-gray-600">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor="autoImplement" className="text-sm text-gray-700">
                      ...
                      <div key={index} className="flex gap-2">
                        ...
                        {formData.testPrices.length > 1 && (
                          <button
                            ...
                            className="mt-7 px-3 py-2 text-red-600 hover:bg-red-50 rounded-lg"
                          >
                            Remove
                          </button>
                        )}
