...
if lsof -ti:8000 >/dev/null 2>&1; then
  ...
  nohup uv run uvicorn main:app --host 0.0.0.0 --port 8000 --reload > logs/legacy_backend.log 2>&1 &
  sleep 2
...
if lsof -ti:8001 >/dev/null 2>&1; then
  ...
  nohup uv run uvicorn ospra_os.main:app --host 0.0.0.0 --port 8001 --reload > logs/backend.log 2>&1 &
  sleep 2
