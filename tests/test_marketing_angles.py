...
async def test_marketing_angle_generator():
    ...
    try:
        ...
        print(f"✓ Angle generated: {angle['angle']}")
        ...
        print(f"✓ Generated {len(angles)} unique angles:")
        ...
        print(f"✓ Found {len(available)} available angles:")
...
async def demonstration():
    ...
    try:
        ...
        print("\n" + "="*70)
        print("✅ RESULT: Same product, 3 completely different marketing approaches!")
...
async def main():
    ...
    try:
        ...
        print("TEST SUMMARY")
        print("="*70)
        print(f"✓ MarketingAngleGenerator Service: {'PASSED' if test1_passed else 'FAILED'}")
        ...
        if test1_passed and test2_passed:
            ...
            print("  ✓ AI-powered unique positioning per user")
            print("  ✓ 6+ niches with tailored angles")
            print("  ✓ Prevents direct competition")
