...
print("1️⃣  Testing TikTok Shop Scraper...")
tiktok = TikTokShopScraper()
print(f"   Initialized: ✅")
print(f"   Available: {'✅ Yes' if tiktok.is_available() else '❌ No (APIFY_API_TOKEN not set)'}")
print(f"   Actor ID: {tiktok.TIKTOK_SHOP_ACTOR}")
print()

# Test Amazon Bestsellers Scraper
print("2️⃣  Testing Amazon Bestsellers Scraper...")
amazon_bs = AmazonBestsellersScraper()
print(f"   Initialized: ✅")
print(f"   Available: {'✅ Yes' if amazon_bs.is_available() else '❌ No (APIFY_API_TOKEN not set)'}")
print(f"   Actor ID: {amazon_bs.ACTOR_ID}")
print()

print("="*70)
print("✅ APIFY SCRAPERS TEST COMPLETE")
print("="*70)
print()
print("Summary:")
print("  ✅ TikTok Shop Scraper: Imported and initialized")
print("  ✅ Amazon Bestsellers Scraper: Imported and initialized")
print()
print("Next Steps:")
